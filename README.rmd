...
I have tried to make an RShiny application that is highly portable, well documented, and requires minimal coding in order to lower the bar for other regions who might like to implement this type of "growing shade" analysis. Everything is open source! 

Please navigate to the `Tutorial.Rmd` script to begin processing data for other regions.
